    ...
    <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          {formData.origin === 'SOUTH' && (
            <SearchableSelect
              ...
              onChange={(value) => setFormData((prev: any) => ({ ...prev, birthRegion: value }))}
              placeholder="시/도 선택"
          ...
          {formData.origin === 'NORTH' && (
            <div className="grid grid-cols-2 gap-3">
              <SearchableSelect
                ...
                value={formData.birthRegion}
                onChange={(value) => setFormData((prev: any) => ({ ...prev, birthRegion: value, birthCity: '' }))}
                placeholder="시/도 선택"
              ...
              <SearchableSelect
                ...
                onChange={(value) => setFormData((prev: any) => ({ ...prev, birthCity: value }))}
                placeholder="시/군 선택"
      ...
      <div>
        ...
        <SearchableSelect
          ...
          onChange={(value) => setFormData((prev: any) => ({ ...prev, residenceRegion: value }))}
          placeholder="시/도 선택"
          searchPlaceholder="지역 검색..."
          icon={<MapPin className="w-5 h-5" />}
        />
