...
export default function DeleteAccountForm() {
  ...
  if (step === 1) {
    return (
      <div className="bg-white rounded-2xl border border-zinc-100 shadow-sm p-6">
        <h2 className="text-lg font-semibold text-zinc-900 mb-4">정말 탈퇴하시겠습니까?</h2>
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-zinc-100 shadow-sm p-6">
      <h2 className="text-lg font-semibold text-zinc-900 mb-4">최종 확인</h2>
      ...
      <div className="space-y-4">
        ...
        <div>
          <label htmlFor="confirmation" className="block text-sm font-medium text-zinc-700 mb-1">
