...
export default function ChallengeForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {type === 'GENRE_SPECIFIC' && (
        <div>
          <label htmlFor="targetGenre" className="block text-sm font-medium text-zinc-700 mb-1">
            대상 장르
          </label>
          <input
            id="targetGenre"
      ...
      <div>
        <label htmlFor="targetValue" className="block text-sm font-medium text-zinc-700 mb-1">
          목표 권수
        </label>
        <input
          id="targetValue"
