...
export default function BookshelfFilter({ seasons, years }: BookshelfFilterProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-zinc-100 shadow-sm p-4 mb-6">
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        {hasFilters && (
          <button
            ...
            className="flex items-center gap-1 px-3 py-2 text-sm text-zinc-500 hover:text-zinc-700"
          >
            <X className="w-4 h-4" />
            초기화
          </button>
